# Sentinel run — 2026-07-10 16:37 UTC
...
- `GLOBAL` **ssl_expiring_transient** — failed once, passed on confirmation re-fetch (likely cache/transient): TLS certificate for enormousdoor.com expires in 16 day(s) — Squarespace should auto-renew; investigate why it hasn't
